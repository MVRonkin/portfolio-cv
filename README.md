...
|  |   |
| :- | - |
|2023 - н.в. | **Руководитель образовательной программы**  Инженерия Искусственного интеллекта 09.04.01 (ИРИТ-РТФ УрФУ, в 2024 году программа вошла в топ-10 программ магистратуры УрФУ); <br> **Академический директор программ** 09.04.01  «Инженерия машинного обучения» (сетевая программа совместно с ООО «Нетология»), [09.04.02 «Прикладной Искусственный интеллект» (сетевая программа совместно с ООО «Нетология»)](https://netology.ru/programs/prikladnoj-iskusstvennyj-intellekt?utm_source=edu.urfu&utm_medium=programs&utm_campaign=netology).|
...
|2024 -2024|*Руководитель* научно-исследовательского коллектива УРФУ в проекте УМНОЦ «Платформа автоматического управления промышленными объектами на базе искусственного интеллекта» |
...
|2013 - 2021|*Ответственный исполнитель* в ряде работ по тематике «ультразвуковой накладной расходомер со сложно-модулированными сигналами», в том числе работ по разработке расходомеров для жидкостей и газов в трубопроводах, ультразвуковых анемометров и датчиков пенообразования в трубопроводах.|
